...
seed = 1212
np.random.seed(seed)
y_anchor= np.arange(100,1000,5)
x_anchor=np.arange(200,1100,5)
...
def get_dataset(i_y,i_x,pixel_size=5,seed=1212):
    np.random.seed(seed)
    ...
    x_train=np.zeros((1000*10,1,5,5),dtype=np.float32)
    ...
    x_val=np.zeros((100*10,1,5,5),dtype=np.float32)
    ...
    x_test=np.zeros((100*10,1,5,5),dtype=np.float32)
    ...
    x_aug=np.zeros((120,1,5,5),dtype=np.float32)
    for i in range(120):
        x_aug[i,0]=(zoom(dark_img,(5/pixel_size,5/pixel_size))*aug_rand[i]).astype(np.float32)
...
def train_pixel(i_y,i_x,pixel_size=5,seed=1212):
